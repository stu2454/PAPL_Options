          ...
          <div className="grid md:grid-cols-2 gap-6 my-6">
            <div className="p-4 bg-green-50 rounded-lg border border-green-200">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><strong>Solution:</strong> Web search tool + API + downloadable documents</li>
                <li><strong>Adoption:</strong> 70%+ of users now use web tool as primary interface</li>
                <li><strong>Result:</strong> Faster lookups, reduced errors, equitable access</li>
              </ul>
            </div>
            ...
            <div className="p-4 bg-green-50 rounded-lg border border-green-200">
              ...
              <ul className="space-y-2 text-sm">
                <li><strong>Challenge:</strong> Pharmacists needed current pricing/authority requirements</li>
                <li><strong>Solution:</strong> Structured database → web interface → documents → API</li>
                <li><strong>Adoption:</strong> High usage across all access tiers</li>
                <li><strong>Result:</strong> Real-time updates, eliminated version control issues</li>
              </ul>
            </div>
          </div>

          <div className="p-4 bg-blue-50 rounded-lg">
            <p className="font-semibold text-blue-900 mb-2">Key Pattern:</p>
            <p className="text-gray-800">
              Successful transformations maintained traditional documents while adding modern access
              methods. Users self-selected appropriate tools based on their needs and capabilities.
              No one was forced to change, but most chose efficiency when offered.
            </p>
          </div>

          <p>
            NDIS already has the technical foundation—the Product Catalogue API demonstrates the
            agency's capability. Option 3 extends this proven infrastructure to PAPL during the
            transition period.
          </p>
        </div>
      </div>
